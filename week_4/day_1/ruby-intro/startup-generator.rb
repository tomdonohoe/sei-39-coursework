...
# idea_one = that_array[(rand() * that_array.length).floor()]
# idea_two = this_array[(rand() * that_array.length).floor()]

# puts("#{idea_one} for #{idea_two}")

puts("#{that_array.sample()} for #{this_array.sample()}")